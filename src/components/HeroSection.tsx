    ...
    <section id="home" className="min-h-screen flex items-center justify-center section-padding pt-32 pb-20">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 leading-tight">
          Hola, soy <span className="text-teal-400">Tu Nombre</span>
        </h1>
        ...
        <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto mb-12">
          Creo experiencias digitales atractivas y funcionales con un enfoque minimalista y centrado en el usuario.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Button asChild variant="outline" className="border-teal-500 text-teal-500 hover:bg-teal-50">
            <a href="/cv.pdf" target="_blank" rel="noopener noreferrer">Descargar CV</a>
          </Button>
        </div>
